...
const certificateData = [
  ...
  },
  {
    ...
    provider: 'Udemy',
    // Image stored under public/certificates
    image: `${process.env.PUBLIC_URL}/certificates/UnrealUdemyCert.jpg`,
    verifyUrl: 'https://www.udemy.com/certificate/UC-7c7eb55a-0854-453f-b447-47426e4da82a/',
    attachments: [],
    tags: ['C++', 'Unreal Engine 5', 'UE5']
  }
];
